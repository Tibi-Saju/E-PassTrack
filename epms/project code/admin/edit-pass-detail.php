...
$eid=$_GET['editid'];
$sql="update tblpass set FullName=:fname,ContactNumber=:cnum,Email=:email,IdentityType=:itype,IdentityCardno=:icnum,Category=:cat,destination=:destination,FromDate=:fdate,ToDate=:tdate where ID=:eid";
...
<head>
    ...
    <title>E-Pass Management System | Edit Pass</title>
